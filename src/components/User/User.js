...
class User extends Component {
  ...
  async componentWillMount() {
    ...
    try {
      const response = await axios.get('https://mojitobooks.pythonanywhere.com/users/' + this.username, { headers: header });
    ...
    try {
      const accountResponse = await axios.get('https://mojitobooks.pythonanywhere.com/profile', { headers: header });
